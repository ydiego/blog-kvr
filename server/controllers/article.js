...
const create = async ctx => {
  ...
  if (!params.title) {
    ctx.body = responseParamsError(null, "title is required!");
    return false;
  }
  try {
...
const detail = async ctx => {
  ...
  if (!article) {
    ctx.body = responseNoData("article not exist");
    return false;
  }
...
const update = async ctx => {
  ...
  if (!title) {
    ctx.body = responseParamsError(null, "article title is required");
    return;
  }
  try {
...
const destroy = async ctx => {
  ...
  if (!id) {
    ctx.body = responseParamsError(null, "article id is required");
    return false;
  }
